...
if (gl) {
    ...
    const fragSrc = [
        ...
        '    // This loop creates the endlessly intricate, zooming lattice',
        ...
        '        float s = sin(t * 0.3 + i), c = cos(t * 0.3 + i);',
        '        uv *= mat2(c, -s, s, c);',
        '',
        ...
        '',
        '        // Create glowing neon sine rings',
        '        d = sin(d * 10.0 + t) / 10.0;',
        '        d = abs(d);',
        '',
        ...
        '    finalColor *= 0.3;',
        '',
        '    // Deep heavy vignette to frame the UI content',
        '    float vig = 1.0 - length(uv0) * 1.0;',
