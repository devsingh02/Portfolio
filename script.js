...
if (gl) {
    ...
    const fragSrc = [
        ...
        '    uv += (u_mouse - 0.5) * 0.1;',
        '',
        '    // 6-Fold Symmetry for simpler, softer geometry',
        ...
        '    float t = u_time * 0.1;',
        '',
        '    // Iterations reduced to 2 for large, soft, simple geometric blobs',
        '    for (float i = 0.0; i < 2.0; i++) {',
        '        uv = abs(uv) - 0.4;',
        '        uv = fract(uv * 1.2 - t * 0.2) - 0.5;',
        '',
        '        float s = sin(t * 0.2 + i * 0.5), c = cos(t * 0.2 + i * 0.5);',
        '        uv *= mat2(c, -s, s, c);',
        '',
        ...
        '        d = abs(d);',
        '',
        '        // Highly diffused foggy bloom instead of sharp lines',
        '        d = pow(0.04 / d, 0.7);',
        '',
        '        finalColor += col * d;',
        '    }',
